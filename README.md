...
- [IntelliCode API Usage Examples](https://marketplace.visualstudio.comVisualStudioExptTeam.intellicode-api-usage-examples/items?itemName=)
...
- [Markdown All in One](https://marketplace.visualstudio.com/itemsyzhang.markdown-all-in-one?itemName=)
- [Markdown Emoji](https://marketplace.visualstudio.com/items?itemName=bierner.markdown-emoji)
- [Markdown Everywhere](https://marketplace.visualstudio.com/itemszhaouv.vscode-markdown-everywhere?itemName=)
